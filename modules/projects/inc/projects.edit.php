...
$t->assign(array(
	...
	"PRJEDIT_FORM_TRANSP" => create_avtospisok_selectbox('rtransp',$item['item_transp'],'class="form-control"'),
	...
	"PRJEDIT_FORM_TITLE" => cot_inputbox('text', 'rtitle', $item['item_title'], 'size="56" class="form-control" '.$disable),
	...
	"PRJEDIT_FORM_COST" => cot_inputbox('text', 'rcost', $item['item_cost'], 'size="10" class="number form-control"'),
	"PRJEDIT_FORM_COUNT" => cot_inputbox('text', 'rcount', $item['item_count'], 'size="10" class="number form-control"'),
	"PRJEDIT_FORM_MASSA" => cot_inputbox('text', 'rmassa', $item['item_massa'], 'size="10" class="number form-control" '.$disable),
	"PRJEDIT_FORM_VOL" => cot_inputbox('text', 'rvol', $item['item_vol'], 'size="10" class="number form-control" '.$disable),
    ...
    "PRJEDIT_FORM_FROM"=>cot_inputbox('text','rfrom',cot_date('d.m.Y',$item['item_datefrom']),'id="date_from" class="form-control"'.$disable),
    "PRJEDIT_FORM_TO"=>cot_inputbox('text','rto',cot_date('d.m.Y',$item['item_dateto']),'id="date_to" class="form-control"'.$disable),
	"PRJEDIT_FORM_FRT"=>cot_get_frt4('rfrt',$item['item_frt']),
