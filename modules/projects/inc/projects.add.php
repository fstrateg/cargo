...
$t->assign(array(
	...
	"PRJADD_FORM_TRANSP" => create_avtospisok_selectbox('rtransp',$ritem['item_transp'],' class="form-control"'),
	...
	"PRJADD_FORM_TITLE" => cot_inputbox('text', 'rtitle', $ritem['item_title'], 'size="56" class="form-control"'),
	...
	"PRJADD_FORM_COST" => cot_inputbox('text', 'rcost', $ritem['item_cost'], 'size="10" class="number form-control"'),
    "PRJADD_FORM_COUNT" => cot_inputbox('text', 'rcount', $ritem['item_count'], 'size="10" class="number form-control"'),
    "PRJADD_FORM_MASSA" => cot_inputbox('text', 'rmassa', $ritem['item_massa'], 'size="10" class="number form-control"'),
    "PRJADD_FORM_VOL" => cot_inputbox('text', 'rvol', $ritem['item_vol'], 'size="10" class="number form-control"'),
    "PRJADD_FORM_PARSER" => cot_selectbox($cfg['projects']['parser'], 'rparser', $parser_list, $parser_list, false),
    "PRJADD_FORM_FROM"=>cot_inputbox('text','rfrom',cot_date('d.m.Y',$ritem['item_datefrom']),'id="date_from" class="form-control"'),
    "PRJADD_FORM_TO"=>cot_inputbox('text','rto',cot_date('d.m.Y',$ritem['item_dateto']),'id="date_to" class="form-control"'),
	"PRJADD_FORM_FRT"=>cot_get_frt4('rfrt',$ritem['item_frt']),
    "PRJADD_FORM_FRT1"=>cot_inputbox('checkbox','rfrt_full',$ritem['item_frt']),
    "PRJADD_FORM_FRT2"=>cot_inputbox('checkbox','rfrt_coll',$ritem['item_frt']),
));
