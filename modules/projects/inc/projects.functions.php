								  ...
								  $pagepath_home = false, $emptytitle = '')
{
	...
	if ($item_data['item_id'] > 0 && !empty($item_data['item_title']))
	{
		...
		$temp_array = array(
			...
			'REALIZED' => $item_data['item_realized']==$item_data['item_count']? 1: 0,
			'ISINWORK' => $item_data['item_inwork'],
			'ISPUBLISH' => ($item_data['item_state']==1&&$item_data['item_count']>$item_data['item_performer'])? 1 : 0,
			...
			'COUNT_OST' => $item_data['item_count']-$item_data['item_performer'],
