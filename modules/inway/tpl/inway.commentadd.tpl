...
<!-- END:SAVED -->
<!-- BEGIN: REPLY -->
<form id="cmForm" action="{FSAVE}" method="post" class="ajax post-comments{FID}">
    <div class="row">
        <div class="col">
            {PHP.L.inway_yourcomment}
        </div>
    ...
    <div class="row">
        <div class="col">
            <input type="submit" value="{PHP.L.Save}" class="aslink mt-3"/>
            <a class="ajax ml-3 mt-3"  href="{FCANSEL}" rel="get-comments{FID}">{PHP.L.Cancel}</a>
...
<!-- END: REPLY -->
<!-- BEGIN:REPLY_CANSEL -->
<a class="ajax" href="{BUT_URL}" rel="get-comments{BUT_NUM}">{PHP.L.inway_addreply}</a>
<!-- END:REPLY_CANSEL -->