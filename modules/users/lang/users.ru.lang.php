...
$L['Fio']='ФИО для обращения';
$L['FioOrFirm']='(или название фирмы)';
$L['Phone']='Номер телефона';

$L['users_begin']='Давайте начнем';
$L['users_say']='Для начала скажите, что Вам нужно?';
$L['users_trcargo']='Мне нужно перевезти груз';
$L['users_needtransp']='мне нужен транспорт';
$L['users_hiretransp']='Нанять транспорт';
$L['users_havetransp']='У меня есть транспорт';
$L['users_fcargo']='я ищу груз';
$L['users_findcargo']='Найти груз';
$L['users_register']='Зарегистрироваться';
$L['users_regcargo']='Регистрация грузоотпровителя';
$L['users_regastransp']='Зарегистрироваться как перевозчик';
$L['users_transpcargo']='Хотите сами перевозить грузы?';
$L['users_transpreg']='Регистрация перевозчика';
