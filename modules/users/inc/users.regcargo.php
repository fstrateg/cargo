...
if ($a=='add')
{
	...
	{
		cot_redirect(cot_url('users', 'm=regcargo', '', true));
	}
}
...
if ($m=='regtransp')
	{
		$mskin = cot_tplfile('users.regtransp', 'module');
		$maingroup='4';
	}
else {
	$mskin = cot_tplfile('users.regcargo', 'module');
	$maingroup='7';
}
...
// 	}
 //splace();
//]]></script>";
$t->assign('USERS_REGISTER_VERIFYINPUT',$t->get('USERS_REGISTER_VERIFYINPUT').$script);
