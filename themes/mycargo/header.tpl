...
<body>
	...
	<nav id="wrapper" class="container">
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mr-auto">
					...
					<!-- END: GUEST -->
					<!-- BEGIN: USER -->
					<li class="nav-item"><a href="{PHP.usr.name|cot_url('users', 'm=details&u='$this)}" style="padding-top: 6px"><img src="/images/{HEADER_IMG}" title="{HEADER_IMGTITLE}" /> {HEADER_USERNAME} [ID{PHP.usr.id}]</a></li>
			...
			<div class="navbar-inner">
				<div class="container">
						<ul class="nav pull-right">
							...
							<!-- END: GUEST -->
							<!-- BEGIN: USER -->
							<li><a href="{PHP.usr.name|cot_url('users', 'm=details&u='$this)}" style="padding-top: 6px"><img src="/images/{HEADER_IMG}" title="{HEADER_IMGTITLE}" /> {HEADER_USERNAME} [ID{PHP.usr.id}]</a></li>
		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="nav">
					...
					<li<!-- IF {PHP.env.ext} == 'marshrut' --> class="active"<!-- ENDIF -->><a href="{PHP|cot_url('marshrut')}">{PHP.L.hea_claims}</a></li>
