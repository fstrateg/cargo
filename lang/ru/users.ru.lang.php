...
$L['pasrec_mailsent2'] = 'Пароль изменен. Пожалуйста, проверьте ваш почтовый ящик через несколько минут, чтобы получить новый пароль.<br/><b>Возможно письмо помечено как СПАМ Вашим почтовым сервисом. Проверьте папку СПАМ!</b>';
